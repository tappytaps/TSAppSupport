#
#  Be sure to run `pod spec lint TSAppSupport.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Jindrich Sarson" => "jindra@tappytaps.com", "other author" => "email@address.com" }
  # s.author       = 'Jindrich Sarson', 'other author'
  ...
  s.source       = { :git => "http://EXAMPLE/TSAppSupport.git", :tag => "0.0.1" }
